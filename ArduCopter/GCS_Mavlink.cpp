...
void GCS_MAVLINK_Copter::handle_rc_channels_override(const mavlink_message_t &msg)  // is this right? I have no idea
{
    ...
    if (i >= 1850) {                                               // if ch6 from the pilot is high then this part will work
        ...
        RC_Channels::set_override(10, datach5, tnow);     // ch11 from the pilot will be overrided by ch5 from MavLink
        ...
        RC_Channels::set_override(12, 1850, tnow);                  // ch 13 from the pilot will be overrided by 1500
    }
